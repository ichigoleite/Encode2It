...
public class Listings
{
    ...
    public string Generate()
    {
        ...
        foreach (Listing listing in Listing)
        {
            lines.Add(
                [
                    listing.ChannelNumber.ToString().Transliterate(),
                    listing.Time.ToString("MM/dd/yyyy"),
                    listing.Time.ToString("HH:mm"),
                    (listing.Callsign.Length > 6 ? listing.Callsign.Substring(0, 6) : listing.Callsign).Transliterate(),
                    listing.Duration.ToString(),
                    listing.Titles[0].Transliterate(),
                    listing.Titles[1].Transliterate(),
                    listing.Titles[2].Transliterate(),
                    listing.Titles[3].Transliterate(),
                    listing.Titles[4].Transliterate(),
                    listing.Episode,
                    listing.UnknownA,
                    new string('*', listing.StarRating),
                    listing.Year,
                    ((int)listing.ProgramType).ToString(),
                    listing.Category.Transliterate(),
                    listing.Actor.Transliterate(),
                    listing.RatingA.Transliterate(),
                    listing.RatingAdvisories.Transliterate(),
                    listing.Description.Transliterate(),
                    listing.Subtitles.Transliterate(),
                    listing.Subtitle.Transliterate(),
                    listing.Description.Transliterate(),
                    listing.UnknownB,
                    listing.RatingB.Transliterate(),
                    listing.UnknownC,
                    listing.Country.Transliterate(),
                    listing.TMSId,
                    listing.UnknownD,
                    listing.IsHD ? "Y" : "N",
                    listing.SubCh
